...
class WordModel:
    ...
    def test_model(self, test_dir):
        ...
        # get the test corpus
        teste_corpus = "../corpus_char/tmVarCorpus/treated/test_data.txt"
        teste_labels = "../corpus_char/tmVarCorpus/treated/test_labels.tsv"
        cr = corpusreader.CorpusReader(teste_corpus, teste_labels)
        corpus = cr.trainseqs
...
if __name__ == "__main__":
    ...
    #test_dir = '../corpus_char/tmVarCorpus/treated/test_data/'
    #model.test_model(test_dir)
