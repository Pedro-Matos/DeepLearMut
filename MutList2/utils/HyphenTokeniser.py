...
_splitSuffixes = {'related', 'promoted', 'soluble', 'linked', 'isomer', 'saturated', 'bonded', 'blood', 'SAMs',
                  'transferrin', 'analogous', 'layer', 'exchange', 'independent', 'treated', 'cation', 'enzyme',
                  'shaped', 'guest', 'derivatives', 'BSA', 'labelled', 'group', 'tethered', 'coordinated', 'biomonitor',
                  'intermediate', 'type', 'mediated', 'treatment', 'catalysed', 'lactoferrin', 'substituent', 'the',
                  'protein', 'protected', 'assisted', 'disubstituted', 'selectivity', 'configuration', ',', 'form',
                  'enriched', 'containing', 'only', 'like', 'catalyzed', 'octahedra', 'chains', 'initiated', 'moiety',
                  'ligand', 'binding', 'units', 'strategy', 'compounds', 'bond', 'bound', 'bonding', 'ions', 'bridged',
                  'modified', 'filled', '15', 'stabilised', 'derived', 'position', 'terminated', 'protecting', 'PAGE',
                  'bonds', 'complexes', 'substituted', 'hyperaccumulator', 'donor', 'coating', 'terminal', 'isomers',
                  'coated', 'peptide', 'based', 'complex', 'unsaturated'}

_clmSplitSuffixes = {'related', 'promoted', 'soluble', 'linked', 'isomer', 'saturated', 'bonded', 'blood', 'SAMs',
                     'transferrin', 'analogous', 'layer', 'exchange', 'independent', 'treated', 'cation', 'enzyme',
                     'shaped', 'guest', 'derivatives', 'BSA', 'labelled',
                     'group', 'tethered', 'coordinated', 'biomonitor', 'intermediate', 'type', 'mediated', 'treatment',
                     'catalysed', 'lactoferrin', 'substituent', 'the', 'protein', 'protected', 'assisted',
                     'disubstituted', 'selectivity', 'configuration', ',', 'form', 'enriched',
                     'containing', 'only', 'like', 'catalyzed', 'octahedra', 'chains', 'initiated', 'moiety', 'ligand',
                     'binding', 'units', 'strategy', 'compounds', 'bond', 'bound', 'bonding', 'ions', 'bridged',
                     'modified', 'filled', '15', 'stabilised', 'derived',
                     'position', 'terminated', 'protecting', 'PAGE', 'bonds', 'complexes', 'substituted',
                     'hyperaccumulator', 'donor', 'coating', 'terminal', 'isomers', 'coated', 'peptide', 'based',
                     'complex', 'unsaturated', "atom", "atoms", "analog", "analogs", "analogue",
                     "analogues", "induced", "terminal", "agonist", "agonistic", "agonists", "antagonist",
                     "antagonistic", "antagonists", "attached", "dimer", "dimers", "responsive", "responsiveness",
                     "linked", "link", "linkage", "linkages", "links", "receptor", "receptors",
                     "type", "types", "typed", "substituted", "donor", "donors", "terminal", "terminus", "garlic",
                     "bound", "dependent", "independent", "inhibitor", "inhibitors", "inducer", "inducers",
                     "ingredient", "tree", "trees", "and", "bond", "bonds", "component",
                     "sensitive", "bit", "S-transferase", "substituent", "polymer", "polymers", "lower", "upper"}

_noSplitPrefixes = {'kappa', 'cyclo', 'mono', 'ent', 'dl', 'tele', 'sec', 'hydro', 'rho', 'yl', 'sym', 'epsilon', 'nu',
                    'glucono', 'nor', 'cis', 'epi', 'myo', 'n-boc', 'catena', 'phi', 'trans', 'iso', 'neo', 'anti',
                    'sigma', 'nido', 'closo', 'amino', 'ortho', 'beta', 'gamma', 'unsym', 'eta', 'keto', 'muco', 'syn',
                    'chi', 'tert', 'triangulo', 'zeta', 'as', 'iota', 'scyllo', 'gluco', 'tau', 'meta', 'mu', 'sn',
                    'allo', 'homo', 'lambda', 'omicron', 'threo', 'bis', 'exo', 'semi', 'xi', 'omega', 'pi', 'alpha',
                    'theta', 'oxy', 'psi', 'upsilon', 'para', 'endo', 'non', 'meso', 'de', 'delta', 'arachno'}
