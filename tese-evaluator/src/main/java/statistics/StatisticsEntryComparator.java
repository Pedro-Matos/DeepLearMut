 ...
 * @since 1.0
 */
public class StatisticsEntryComparator implements
        Comparator<StatisticsEntry>, Serializable {
     ...
     * @return
     * <code>1</code> if the 1st annotation appears latter in the sentence, and
     * <code>-1</code> if the 2nd annotation appears latter in the sentence.
     */
    @Override
    public int compare(final StatisticsEntry t, final StatisticsEntry t1) {
