...
//        String silverFolderPath = "/Volumes/data/Dropbox/PhD/work/platform/code/neji/resources/corpus/scai/test/silver/";
        ...
        if (goldFiles.length != silverFiles.length) {
            System.out.println((goldFiles.length));
            System.out.println((silverFiles.length));
            System.out.println("\n");
            int i;
            for (i=0; i<silverFiles.length; i++){
                System.out.println(i);
                System.out.println(silverFiles[i]);
                System.out.println(goldFiles[i]);
                System.out.println("------");
            }
